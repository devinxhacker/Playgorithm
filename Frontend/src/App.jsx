...
function App() {
  ...
  useEffect(() => {
    // Always show loading screen for 2 seconds on startup/refresh
          ...
          <div className="row">
            ...
            <div className="col-lg-2 col-md-6 mb-4">
              ...
              <ul className="footer-links">
                <li>
                  <a href="#features" className="cursor-target">Features</a>
                </li>
                <li>
                  <a href="#battles" className="cursor-target">Battles</a>
                </li>
                <li>
                  <a href="#leaderboard" className="cursor-target">Leaderboard</a>
                </li>
                <li>
                  <a href="#tournaments" className="cursor-target">Tournaments</a>
                </li>
              </ul>
            </div>
            ...
            <div className="col-lg-2 col-md-6 mb-4">
              ...
              <ul className="footer-links">
                <li>
                  <a href="#algorithms" className="cursor-target">Algorithms</a>
                </li>
                <li>
                  <a href="#data-structures" className="cursor-target">Data Structures</a>
                </li>
                <li>
                  <a href="#tutorials" className="cursor-target">Tutorials</a>
                </li>
                <li>
                  <a href="#documentation" className="cursor-target">Docs</a>
                </li>
              </ul>
            </div>
            ...
            <div className="col-lg-2 col-md-6 mb-4">
              ...
              <ul className="footer-links">
                <li>
                  <a href="#discord" className="cursor-target">Discord</a>
                </li>
                <li>
                  <a href="#forums" className="cursor-target">Forums</a>
                </li>
                <li>
                  <a href="#blog" className="cursor-target">Blog</a>
                </li>
                <li>
                  <a href="#events" className="cursor-target">Events</a>
                </li>
              </ul>
            </div>
            ...
            <div className="col-lg-2 col-md-6 mb-4">
              ...
              <ul className="footer-links">
                <li>
                  <a href="#help" className="cursor-target">Help Center</a>
                </li>
                <li>
                  <a href="#contact" className="cursor-target">Contact</a>
                </li>
                <li>
                  <a href="#privacy" className="cursor-target">Privacy</a>
                </li>
                <li>
                  <a href="#terms" className="cursor-target">Terms</a>
                </li>
              </ul>
            </div>
          </div>
